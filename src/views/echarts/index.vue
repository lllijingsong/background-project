<template>
  <div>
    <el-button size="mini" @click="loadingEcharts">click</el-button>
    <div class="main-box">
...
const resolve1 = require("./json/index");
const resolve2 = require("./json/index2");
const resolve3 = require("./json/index3");
export default {
  data() {
    return {
      eCharts: null,
  ...
  methods: {
    loadingEcharts(e) {
      const eData = [
          { id: 101, name: "111222333" },
          { id: 1000, name: "test", parent: 101 },
        ],
        eLink = [],
        _this = this;
      ...
      console.log(eData, eLink);

      this.eCharts = echarts.init(document.getElementById("main"));
      this.eCharts.setOption(this.eChartsOption(eData, eLink));
      this.eCharts.on("dblclick", function (params) {
        resolve1.data.forEach((v) => {
          eData.push({
            parent: eData[0].id,
            ...v,
          });
        ...
        console.log(eData, eLink);
        _this.eCharts.setOption(_this.eChartsOption(eData, eLink));
      });
      // console.log(e)
    },
    eChartsOption(eData, eLink) {
      let option = {
        ...
        series: [
          {
            ...
            data: [
              ...
              },
              {
                ...
                hostCpuUsed: 0.34,
                hostCpuLost: 1.58,
                hostRamSize: 16417088,
                hostRamUsedSize: 6689704,
                hostRamAvailableSize: 9727384,
                hostRamUsed: 0.4075,
                hostDiskTotalCapacityKB: 2927493120,
                hostDiskUsedKB: 50399692,
                hostDiskAvailableKB: 2877093428,
                hostDiskUsed: 0.0172,
                roleName: "存储节点",
                businessCnt: 0,
                connectStatus: "在线",
              ...
              },
              {
                ...
                hostCpuLost: 3.57,
                hostRamSize: 16417088,
                hostRamUsedSize: 8065364,
                hostRamAvailableSize: 8351724,
                hostRamUsed: 0.4913,
                hostDiskTotalCapacityKB: 2927493120,
                hostDiskUsedKB: 6261212,
                hostDiskAvailableKB: 2921231908,
                hostDiskUsed: 0.0021,
                roleName: "存储节点",
                businessCnt: 0,
                connectStatus: "在线",
              ...
              },
              {
                ...
                hostCpuLost: 5.58,
                hostRamSize: 16417088,
                hostRamUsedSize: 6858004,
                hostRamAvailableSize: 9559084,
                hostRamUsed: 0.4177,
                hostDiskTotalCapacityKB: 3512991744,
                hostDiskUsedKB: 7236532,
                hostDiskAvailableKB: 3505755212,
                hostDiskUsed: 0.0021,
                roleName: "存储节点",
                businessCnt: 0,
                connectStatus: "在线",
              ...
              },
              {
                ...
                hostCpuUsed: 0.01,
                hostCpuLost: 1.3,
                hostRamSize: 263398136,
                hostRamUsedSize: 46815664,
                hostRamAvailableSize: 216582472,
                hostRamUsed: 0.1777,
                hostDiskTotalCapacityKB: 292968750,
                hostDiskUsedKB: 223103180,
                hostDiskAvailableKB: 69865570,
                hostDiskUsed: 0.7615,
                roleName: "计算节点",
                businessCnt: 15,
                connectStatus: "在线",
              ...
              },
              {
                ...
                comment: null,
                systemType: "Linux",
                applicationName: "测试应用名1",
                vmCpuCoreNum: 2,
                vmRam: 2097152,
                vmTotalDiskCapacity: 104857600,
                instanceName: "KcwUVhhZJKF3",
                state: "关机",
              ...
              },
              {
                ...
                vmCpuCoreNum: 2,
                vmRam: 2097152,
                vmTotalDiskCapacity: 41943040,
                instanceName: "KkNVVhS8p3Ft",
                state: "关机",
                itemStyle: { normal: { color: "#c22900" } },
              },
              {
              ...
              },
              {
                ...
                symbolSize: 30,
                type: "vm",
                comment: "系统盘和数据盘分别使用不同的存储",
                systemType: "Linux",
                applicationName: "运维测试",
                vmCpuCoreNum: 1,
                vmRam: 1048576,
                vmTotalDiskCapacity: 104857600,
                instanceName: "KCRnVhusAfcs",
                state: "关机",
                itemStyle: { normal: { color: "#c22900" } },
              },
              {
                ...
                vmRam: 1048576,
                vmTotalDiskCapacity: 41943040,
                instanceName: "K2WnVheVQHIy",
                state: "开机",
                itemStyle: { normal: { color: "#0065C2" } },
              },
              {
                id: 11,
                name: "混合存储模式测试03",
              ...
              },
              {
                ...
                vmCpuCoreNum: 1,
                vmRam: 1048576,
                vmTotalDiskCapacity: null,
                instanceName: "KScoVhXKFOax",
                state: "关机",
                itemStyle: { normal: { color: "#c22900" } },
              },
              {
                ...
                vmCpuCoreNum: 1,
                vmRam: 1048576,
                vmTotalDiskCapacity: 146800640,
                instanceName: "KieoVhCZfE7H",
                state: "开机",
                itemStyle: { normal: { color: "#0065C2" } },
              },
              {
              ...
              },
              {
                ...
                vmCpuCoreNum: 1,
                vmRam: 1048576,
                vmTotalDiskCapacity: 2097152,
                instanceName: "K0LAZhCinIcn",
                state: "开机",
                itemStyle: { normal: { color: "#0065C2" } },
              },
              {
                ...
                hostCpuUsed: 0,
                hostCpuLost: 2.63,
                hostRamSize: 263578028,
                hostRamUsedSize: 61417000,
                hostRamAvailableSize: 202161028,
                hostRamUsed: 0.233,
                hostDiskTotalCapacityKB: 922114350,
                hostDiskUsedKB: 164727852,
                hostDiskAvailableKB: 715170642,
                hostDiskUsed: 0.1786,
                roleName: "计算节点,存储节点",
                businessCnt: 8,
                connectStatus: "在线",
              ...
              },
              {
                ...
                vmCpuCoreNum: 1,
                vmRam: 1048576,
                vmTotalDiskCapacity: 83886080,
                instanceName: "KnrvVhwZOPgg",
                state: "开机",
                itemStyle: { normal: { color: "#0065C2" } },
              },
              {
                ...
                vmRam: 1048576,
                vmTotalDiskCapacity: 41943040,
                instanceName: "KOJXWhWm2uDc",
                state: "关机",
                itemStyle: { normal: { color: "#c22900" } },
              },
              {
                id: 25,
                name: "test0531yan12345",
                category: 3,
                symbol: "circle",
                symbolSize: 30,
                type: "vm",
              ...
              },
              {
                ...
                comment: null,
                systemType: "Linux",
                applicationName: "云灾备测试",
                vmCpuCoreNum: 4,
                vmRam: 4194304,
                vmTotalDiskCapacity: null,
                instanceName: "KkzxXhFmeOqe",
                state: "关机",
                itemStyle: { normal: { color: "#c22900" } },
              },
              {
              ...
              },
              {
                ...
                hostCpuUsed: 0.12,
                hostCpuLost: 2.76,
                hostRamSize: 16413752,
                hostRamUsedSize: 13411772,
                hostRamAvailableSize: 3001980,
                hostRamUsed: 0.8171,
                hostDiskTotalCapacityKB: 3515088896,
                hostDiskUsedKB: 30268576,
                hostDiskAvailableKB: 3484820320,
                hostDiskUsed: 0.0086,
                roleName: "存储节点",
                businessCnt: 0,
                connectStatus: "在线",
              ...
              },
              {
                ...
                hostCpuLost: 0.16,
                hostRamSize: 16413752,
                hostRamUsedSize: 6855632,
                hostRamAvailableSize: 9558120,
                hostRamUsed: 0.4177,
                hostDiskTotalCapacityKB: 2927493120,
                hostDiskUsedKB: 6256616,
                hostDiskAvailableKB: 2921236504,
                hostDiskUsed: 0.0021,
                roleName: "存储节点",
                businessCnt: 0,
                connectStatus: "在线",
              ...
              },
              {
                ...
                hostCpuUsed: 0.13,
                hostCpuLost: 0.63,
                hostRamSize: 32928816,
                hostRamUsedSize: 8822440,
                hostRamAvailableSize: 24106376,
                hostRamUsed: 0.2679,
                hostDiskTotalCapacityKB: 2927493120,
                hostDiskUsedKB: 13823104,
                hostDiskAvailableKB: 2913670016,
                hostDiskUsed: 0.0047,
                roleName: "存储节点",
                businessCnt: 1,
                connectStatus: "在线",
